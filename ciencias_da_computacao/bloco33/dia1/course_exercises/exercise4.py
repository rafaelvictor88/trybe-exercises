...
book = 24.20
book_with_descount = 24.20 * 60 / 100
print(book_with_descount)

transport_cost = 59 * 0.75 + 3
print(transport_cost)

price_of_sixteen_books = book_with_descount * 60 + transport_cost
print(price_of_sixteen_books)
